...
def generate_podcast_script(historical_figure, background_research=None, script_path=None):
    ...
    Characterization:
    - Leo (Time Traveler): Young, innocent, and somewhat naive, with a deep, restless curiosity and wide-eyed wonder about history. His youth and innocence should come through in his questions and reactions, sometimes showing slight endearing naivety about historical complexities. He's an empathetic listener who asks rather than lectures, intellectually humble, and adaptable to his guest's conversational cadence. Leo should be genuinely funny in an unintentional way—fish-out-of-water quips and occasional anachronistic references to modern concepts that escape before he realizes the era he's in. This humor disappears during somber discussions (about war casualties, persecution, or tragedy), where he shifts to quiet respect and thoughtful follow-ups. He maintains period-appropriate manners while still embodying youthful enthusiasm, offering reflective syntheses as conversations deepen. Don't make him too woke, too cringe, too childish or too goofy — ensure he respects both his character and the historical context.
